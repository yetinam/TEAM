...
from keras.layers import Dense, BatchNormalization, Conv1D, MaxPooling1D, Flatten, Dropout, Lambda, Input, Conv2D, \
...
from keras import initializers, Input, Model, backend as K
import numpy as np
